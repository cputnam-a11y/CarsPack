...
package io.github.sillycarsmc.content.blocks;
...
public final class SillyCarsBlocks {
	private static Block register(final String id, final Function<BlockBehaviour.Properties, Block> factory, final BlockBehaviour.Properties properties) {
		final var resourceKey = ResourceKey.create(Registries.BLOCK, SillyCars.withPath(id));
